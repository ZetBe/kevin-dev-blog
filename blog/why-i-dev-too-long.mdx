...
image: https://res.cloudinary.com/duadxbqwh/image/upload/v1753776627/thumbnail_slw30i.png
authors: Kevin
---

![thumbnail](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776627/thumbnail_slw30i.png)
...
![blog-main](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776628/blog-main_viikic.png)
...
![blog-issue](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776632/blog-issue_kpfinh.png)
...
![can-i-pr](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776626/can-i-pr_hkzx2y.png)
...
![같이 무너짐](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776626/burn_tw707v.png)
...
![result](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776626/result_k1tbkt.gif)

## PR 올리기

![pr](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776625/pr_diwz66.png)
...
![pr-answer](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776623/pr-answer_proznq.png)

다행히도, 정적 검색을 `fumadocs`에서 지원해주었기 때문에, 다음과 같이 3개의 파일에 간단히 코드를 수정하여

빌드 시 `SSG` 형식의 렌더링이 적용되는 것을 확인하였다.

![static-commit](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776622/static-commit_upaguf.png)
![ssg](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776621/ssg_j61hva.png)

그렇게 필자의 PR은 잘 병합되어 해당 저장소에 기여하는 모습을 볼 수 있다.

![github](https://res.cloudinary.com/duadxbqwh/image/upload/v1753776621/github_ci43mc.png)
