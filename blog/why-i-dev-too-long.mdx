...
date: '2025-06-13'
tags: [javascript, next.js, html/css]
summary: |
  간단하게 끝날 것 같은 일이 오래 걸리게 되면서 
  왜이렇게 오래 걸리게 되었고, 어떻게 해결해 나갈지 회고한 글입니다.
images: https://lh3.google.com/u/0/d/1pl623MRqimPpXU9kSc9gf6S3WyyDllL6=w949-h1347-iv1?auditContext=forDisplay
authors: Kevin
---

![thumbnail](https://lh3.google.com/u/0/d/1pl623MRqimPpXU9kSc9gf6S3WyyDllL6=w949-h1347-iv1?auditContext=forDisplay)
...
![blog-main](https://lh3.google.com/u/0/d/1hnwRcuRvMtzea-fS00B0AFxbR3p1l4s1=w2560-h1347-iv1?auditContext=forDisplay)
...
![blog-issue](https://drive.google.com/u/0/drive-viewer/AKGpihbe_XKA1LBxBCGn2itifbhurL3SrVPitjjyuf3tAzlIOQ6BPwQs61IXiXZW8n6kw9PSn_EIk2pXU7dHpFw1Rde7YevS9K7bL9c=s1600-rw-v1)
...
![can-i-pr](https://lh3.google.com/u/0/d/1OuTSHkAiykE8VN7Xx-Dv2wGYEGws3_w5=w949-h1347-iv1?auditContext=forDisplay)
...
![같이 무너짐](https://lh3.google.com/u/0/d/1QfRjCBvenfxQyUxquc0R2euIDnlPEt61=w2560-h1347-iv1?auditContext=prefetch)
...
![result](https://lh3.google.com/u/0/d/13biEt6WJFHy6xIAvTBFoZrXlsXrKy7EP=w949-h1347-iv1?auditContext=forDisplay)

## PR 올리기

![pr](https://lh3.google.com/u/0/d/1uj_0T4EDPrVbM7Yv13YQkrk3FCaY-unX=w949-h1347-iv1?auditContext=forDisplay)
...
![pr-answer](https://lh3.google.com/u/0/d/1lHOuhElPVrk6OjWIb9IHDTKVq4utgcSQ=w949-h1347-iv1?auditContext=forDisplay)

다행히도, 정적 검색을 `fumadocs`에서 지원해주었기 때문에, 다음과 같이 3개의 파일에 간단히 코드를 수정하여

빌드 시 `SSG` 형식의 렌더링이 적용되는 것을 확인하였다.

![static-commit](https://lh3.google.com/u/0/d/16pJF4TLgMscwlsPNWBafPZejlmYEDFt4=w949-h1347-iv1?auditContext=forDisplay)
![ssg](https://lh3.google.com/u/0/d/1TsQFhpp94FBvAis9MnV5OGYeF7GaUgFC=w949-h1347-iv1?auditContext=forDisplay)

그렇게 필자의 PR은 잘 병합되어 해당 저장소에 기여하는 모습을 볼 수 있다.

![ssg](https://lh3.google.com/u/0/d/1DADblANoYwC5y-B1C0_Vgdg_r0i3Ndwg=w949-h1347-iv1?auditContext=prefetch)
